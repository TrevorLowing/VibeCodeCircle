...
namespace Etch_Theme\SureCart\Licensing;
...
class Settings {
	...
	/**
	 * Enqueue the styles for the license page.
	 *
	 * @return void
	 */
	public function enqueue_styles() {
		...
		if ( $screen && strpos( $screen->id, $this->menu_args['menu_slug'] ) !== false ) {
			wp_enqueue_style(
				'etch-admin-styles',
				ETCH_PLUGIN_URL . 'classes/WpAdmin/Assets/css/style.css',
				array(),
				'1.0.0'
			);
		}
